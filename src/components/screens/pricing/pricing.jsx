          ...
          <div className={styles.faq}>
            ...
            <div className={styles.faqGrid}>
              <div className={styles.faqItem}>
                ...
                <p>You'll receive immediate access to post jobs according to your package. Your account will be upgraded and you can start posting right away.</p>
              </div>
              <div className={styles.faqItem}>
                <h4>Can I upgrade my package later?</h4>
                <p>Yes, you can upgrade from Silver to Gold at any time. The remaining value from your current package will be applied to the upgrade.</p>
              </div>
              <div className={styles.faqItem}>
                <h4>Do packages expire?</h4>
                <p>Yes, Silver packages expire after 30 days and Gold packages expire after 90 days from the date of purchase.</p>
              </div>
              <div className={styles.faqItem}>
                <h4>What payment methods do you accept?</h4>
                <p>We accept all major credit cards, debit cards, UPI, and net banking for secure payments.</p>
              </div>
            </div>
          </div>
        </CustomContainer>
