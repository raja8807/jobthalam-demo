    ...
    >
      ...
      {isOpened && (
        <div className={styles.answer}>
          ...
          nemo numquam velit repudiandae esse veniam provident, unde veritatis
          tenetur dolore fugiat quasi sapiente minus quidem voluptatibus
          mollitia similique minima illo.
        </div>
      )}
    </div>
  );
