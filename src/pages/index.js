...
const Home = ({ data }) => {
  const candidateHomePageData = {
    bannerData: data?.homePageData?.bannerData || {
      title: [
        {
    ...
    vacanciesData: data?.homePageData?.vacanciesData || [
      {
        title: "IT Managers",
        positions: 1000,
      },
    ...
    categoryData: data?.homePageData?.categoryData || [
      {
        title: "Design",
        availableJobs: "200",
      },
    ...
    candidateTestimonialsData: data?.candidateTestimonialsData || [
      {
